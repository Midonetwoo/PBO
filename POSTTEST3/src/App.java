...
public class App { 
     ...
     static void readtabletops() {
          int i = 0;
          System.out.println("--------------------------------");
          for (tabletops pro : tabletop) {
               System.out.println("product number." + (i + 1));
               System.out.println(
                         pro.getName() + " " + pro.getId() + "." + pro.getVersion() + ", " + pro.getCategory());
               System.out.println(pro.getPrice() + " (" + pro.getQuantity() + ")");
               System.out.println("Description: " + pro.getDescription() + "(" + pro.getReleasedate() + ")");
               System.out.println("Format: " + pro.getFormat());
               System.out.println("--------------------------------");
               i++;
          }
     }

     static void readdigitalgames() {
          int i = 0;
          System.out.println("--------------------------------");
          for (digitalgames pro : digitalgame) {
               System.out.println("product number." + (i + 1));
               ...
               System.out.println(pro.getPrice() + " (" + pro.getQuantity() + ")");
               System.out.println("Description: " + pro.getDescription() + "(" + pro.getReleasedate() + ")");
               System.out.println("Size: " + pro.getSize());
               System.out.println("Platfrom: " + pro.getPlatfrom());
               System.out.println("--------------------------------");
               i++;
          }
     }

     static void readstartersets() {
          int i = 0;
          System.out.println("--------------------------------");
          for (startetsets pro : startetset) {
               System.out.println("product number." + (i + 1));
